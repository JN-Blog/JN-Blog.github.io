...
* Dans le champ de recheche, écrire *gh-pages*
...
Cette opération se fait auprès de votre fournisseur DNS. Les interfaces sont différentes mais la plupart du temps, l'opération est bien cadré et il suffit d'indiquer au travers d'un formulaire son sous-domaine et le nom de domaine hôte.
...
Notre configuration de GitHub Pages est désormais terminée! Notre repository est prêt à acceuillir notre blog ainsi qu'à le servir sur notre domaine personnalisé.
